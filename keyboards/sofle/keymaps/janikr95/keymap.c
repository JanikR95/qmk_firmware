...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[_MEDIA] = LAYOUT(KC_NO, KC_NO, KC_NO, LALT(KC_F4), KC_NO, KC_NO, KC_NO, KC_NUM, KC_PSLS, KC_PAST, KC_PMNS, KC_F12, KC_GRV, KC_GRV, LCTL(KC_X), LCTL(KC_C), LCTL(KC_V), LSFT(KC_F6), KC_NO, KC_P7, KC_P8, KC_P9, KC_PPLS, KC_DEL, KC_TRNS, KC_NO, KC_NO, RCS(KC_J), LCTL(KC_Y), CW_TOGG, KC_NO, KC_P4, KC_P5, KC_P6, KC_PCMM, KC_BSPC, KC_TRNS, KC_NO, KC_MPRV, KC_MPLY, KC_MNXT, KC_ENT, KC_TRNS, KC_TRNS, KC_NO, KC_P1, KC_P2, KC_P3, KC_PEQL, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_P0, KC_P0, KC_PDOT, KC_COMM),
